...
# Ensure that the right gain_cell exists or use the parameterised one
openram.setup_gain_cell()
...
# Create an gain_cell (we can also pass gain_cell_config, see documentation/tutorials for details)
from openram import gain_cell
s = gain_cell()

# Output the files for the resulting gain_cell
s.save()
