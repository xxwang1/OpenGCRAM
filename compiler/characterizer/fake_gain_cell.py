...
# All rights reserved.
#
from openram import gain_cell_config
from math import ceil
from openram import OPTS


class fake_gain_cell(gain_cell_config):
    """
    This is an gain_cell class that doesn't actually create an instance.
    ...
    def __init__(self, name, word_size, num_words, write_size=None, num_banks=1,
        ...
        gain_cell_config.__init__(self, word_size, num_words, write_size,
