...
for the given dimension gain_cell. It is useful for debugging after an gain_cell has been
...
from gain_cell_config import gain_cell_config
c = gain_cell_config(word_size=OPTS.word_size,
...
from gain_cell import gain_cell
s = gain_cell(name=OPTS.output_name, gain_cell_config=c)
...
if (self.num_spare_rows == 0):
    probe_address = "1" * gain_cell.addr_size
else:
    probe_address = "0" + ("1" * gain_cell.addr_size - 1)
probe_data = gain_cell.word_size - 1
