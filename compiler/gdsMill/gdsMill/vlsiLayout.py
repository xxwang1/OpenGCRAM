...
class VlsiLayout:
    ...
    def __init__(self, name=None, units=(0.001,1e-9), libraryName="DEFAULT.DB", gdsVersion=5):
        ...
        if name:
            ...
            print("initial structure name=", self.structures[self.rootStructureName].name)
    ...
    def rename(self,newName):
        ...
        print("structure rename newname =", self.structures[newName].name)
    ...
    def newLayout(self,newName):
        ...
        print("structure newlayout newname =", self.structures[newName].name)
        self.rootStructureName = newName
    ...
    def addInstance(self,layoutToAdd,nameOfLayout=0,offsetInMicrons=(0,0),mirror=None,rotate=None):
        ...
        if layoutToAdd != self:
            ...
            for structure in layoutToAdd.structures:
                if structure not in self.structures:
                    print("layoutToAdd.rootStructureName =", layoutToAdd.rootStructureName)
                    print("layoutToadd structure=", layoutToAdd.structures[structure].name)
        ...
        print("layoutToAddSref structure=", self.structures[self.rootStructureName].name)
    ...
    def getTexts(self, lpp):
        ...
        text_list = []
        print("*****************************************************")
        print("self.rootStructureName=", self.rootStructureName)
        print("self.structures[self.rootStructureName]=", self.structures[self.rootStructureName])
        print("Texts = ", self.structures[self.rootStructureName].texts)
        print("*****************************************************")
        for Text in self.structures[self.rootStructureName].texts:
            print("Text.drawingLayer =", Text.drawingLayer)
            print("Text.purposeLayer =", Text.purposeLayer)
    ...
    def getPinShape(self, pin_name):
        ...
        print("*****************************************************")
        print("self.pins[pin_map] = ", pin_map)
    ...
    def processLabelPins(self, lpp):
        ...
        for label in labels:
            print("************************************************")
            print("Label = ", label)
            print("label coordinate=", label.coordinates[0])
            print("label text=", label.textString)
            print("************************************************")
