...
class pnand2(pgate):
    ...
    def add_ptx(self):
        ...
        self.pmos_right = factory.create(module_type="ptx",
                                         ...
                                         add_source_contact=self.route_layer,
                                         add_drain_contact=self.route_layer)
        print("self.pmos_right = ", self.pmos_right)
        print("self.pmos_right.pimplant_offset, width = ", self.pmos_right.pimplant_offset, self.pmos_right.pimplant_width)
    def setup_layout_constants(self):
        ...
        print("self.pmos_left.get_pin(D)=", self.pmos_left.get_pin("D"))
        print("self.pmos_left.get_pin(S)=", self.pmos_left.get_pins("S"))
        s_pin_list = list(self.pmos_left.get_pins("S"))
        self.overlap_offset = self.pmos_left.get_pin("D").center() - s_pin_list[0].center()
    ...
    def place_ptx(self):
        ...
        """
        print("running place_ptx for pnand2")
        print("top_bottom_space = ", self.top_bottom_space)
    ...
    def add_implant_encloses(self):
        ...
        self.add_nimplant_enclose(self.nmos_left, self.nmos2_pos)
        self.add_pimplant_enclose(self.pmos_right, self.pmos2_pos)
    ...
    def route_inputs(self):
        ...
        if OPTS.gc_type == "hybrid" or OPTS.gc_type == "OS":
            self.inputA_yoffset = max(active_contact_to_poly_contact,
                                  active_to_poly_contact,
                                  active_to_poly_contact2) + 0.5 * self.m1_pitch - 0.08
        ...
        if OPTS.gc_type == "hybrid" or OPTS.gc_type == "OS":
            # self.inputB_yoffset = self.inputA_yoffset + 1.5 * self.m1_pitch + 0.12
