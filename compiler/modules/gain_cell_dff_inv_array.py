...
class gain_cell_dff_inv_array(design):
    """
    ...
    def __init__(self, rows, columns, inv_size=2, name=""):
        ...
        if name=="":
            name = "gain_cell_dff_inv_array_{0}x{1}_{2}".format(rows, columns, gain_cell_dff_inv_array.unique_id)
            gain_cell_dff_inv_array.unique_id += 1
        super().__init__(name)
