...
class pwrite_driver(design):
    ...
    def get_m6_track(self,i):
        return 0.5*self.m6_space + i*(self.m6_width+self.m6_space)
    def get_m5_track(self,i):
        return 0.5*self.m5_space + i*(self.m5_width+self.m5_space)
