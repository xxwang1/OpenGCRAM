...
class pinvbuf(pgate):
    ...
    def place_modules(self):
        ...
        self.inv2_inst.place(vector(self.inv1_inst.rx() + self.implant_enclose_active, 0))

        # Add INV3 to the right of INV2
        self.inv3_inst.place(vector(self.inv2_inst.rx() + self.implant_enclose_active, 0))

        # Add INV4 flipped to the bottom aligned with INV2
        self.inv4_inst.place(offset=vector(self.inv2_inst.rx() + self.implant_enclose_active,
                                           2 * self.inv2.height),
                             mirror="MX")
