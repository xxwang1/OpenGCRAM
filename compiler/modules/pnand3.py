...
class pnand3(pgate):
    ...
    def add_implant_encloses(self):
        ...
        self.add_nimplant_enclose(self.nmos_right, self.nmos3_pos + vector(self.m1_pitch, 0))
        self.add_pimplant_enclose(self.pmos_right, self.pmos3_pos + vector(self.m1_pitch, 0))
    ...
    def route_inputs(self):
        ...
        if OPTS.gc_type == "hybrid" or OPTS.gc_type == "OS":
            self.inputA_yoffset += 0.5 * self.m1_space - 0.02
        ...
        self.inputB_yoffset = self.inputA_yoffset + self.m3_pitch * 2
        if OPTS.gc_type == "hybrid" or OPTS.gc_type == "OS":
        ...
        self.inputC_yoffset = self.inputB_yoffset + self.m3_pitch * 2
        if OPTS.gc_type == "hybrid" or OPTS.gc_type == "OS":
