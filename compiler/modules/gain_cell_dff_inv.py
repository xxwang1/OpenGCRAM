...
class gain_cell_dff_inv(design):
    """
    ...
    def __init__(self, inv_size=2, name=""):
        ...
        if name=="":
            name = "gain_cell_dff_inv_{0}".format(gain_cell_dff_inv.unique_id)
            gain_cell_dff_inv.unique_id += 1
        super().__init__(name)
    ...
    def create_layout(self):
        self.width = self.gain_cell_dff.width + self.inv1.width
    ...
    def add_modules(self):
        self.gain_cell_dff = gain_cell_dff_inv.gain_cell_dff_inv(self.inv_size)
    ...
    def create_modules(self):
        self.gain_cell_dff_inst=self.add_inst(name="gain_cell_dff_inv_gain_cell_dff",
                                    mod=self.gain_cell_dff)
        self.connect_inst(["D", "Q", "clk", "vdd", "gnd"])

        self.inv1_inst=self.add_inst(name="gain_cell_dff_inv_inv1",
                                     mod=self.inv1)
    ...
    def place_modules(self):
        ...
        self.inv1_inst.place(vector(self.gain_cell_dff_inst.rx(),0))
    ...
    def add_layout_pins(self):
        ...
        dout_pin = self.gain_cell_dff_inst.get_pin("Q")
