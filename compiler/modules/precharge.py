...
class precharge(design):
    ...
    def place_ptx(self):
        ...
        ydiff = self.pmos.height + 2 * self.m2_pitch + self.poly_width
        ...
        #                 offset=vector(self.upper_pmos1_pos.x + overlap_offset.x, self.initial_yoffset - self.poly_extend_active - self.implant_enclose_poly),
        #                 width=self.pmos.pimplant_width - self.implant_enclose_active,
        #                 height=ydiff)
    ...
    def place_nwell_and_contact(self):
        ...
        print("place nwell and contact well_contact_pos = ", self.well_contact_pos)
