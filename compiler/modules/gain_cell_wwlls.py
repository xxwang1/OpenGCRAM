...
class gain_cell_wwlls(design):
    ...
    def __init__(self, name="wwlls"):
        super().__init__(name, prop=props.gain_cell_wwlls)
        debug.info(2, "Create wwlls")

    def get_we_names(self):
        return "WE_clk"

    def get_we_shifted_names(self):
        return "WE_shifted"
