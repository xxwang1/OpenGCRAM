...
class pinv_dec(pinv):
    ...
    def extend_implants(self):
        ...
        ll = (self.nmos_inst.ll() - vector(self.implant_enclose_active, self.implant_enclose)).scale(1, 0)
        ...
        ll = (self.pmos_inst.ll() - vector(self.implant_enclose_active, self.implant_enclose)).scale(1, 0)
        # Don't route to the top
