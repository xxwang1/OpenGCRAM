...
class gain_cell_wordline_driver(design):
    ...
    """
    def __init__(self, name, cols, port, height=None):
    ...
    def create_insts(self):
        if self.port in self.read_ports: 
            self.nand_inst = self.add_inst(name="rwld_nand",
                                       mod=self.nand)
    ...
    def place_insts(self):
        ...
        self.driver_inst.place(offset=vector(self.nand_inst.rx() + self.well_extend_active, 0))
