...
class pinv(pgate):
    ...
    def add_ptx(self):
        ...
        print("add_ptx nmos width and pmos width = ", self.nmos_width, self.pmos_width)
    ...
    def create_ptx(self):
        ...
        """
        print("create_ptx nmos width and pmos width = ", self.nmos.tx_width, self.pmos.tx_width)
    ...
    def add_implant_encloses(self):
        ...
        self.add_nimplant_enclose(self.nmos, self.nmos_pos)
        self.add_pimplant_enclose(self.pmos, self.pmos_pos)
