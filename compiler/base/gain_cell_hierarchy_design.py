...
from .gain_cell_hierarchy_layout import layout
from .gain_cell_hierarchy_spice import spice


class gain_cell_hierarchy_design(spice, layout):
    """
    ...
    def DRC_LVS(self, final_verification=False, force_check=True):
