...
#
"""
This script will functionally simulate an gain_cell previously generated by OpenRAM
...
# Configure the gain_cell organization (duplicated from gain_cell_compiler.py)
from openram.characterizer.fake_gain_cell import fake_gain_cell
s = fake_gain_cell(name=OPTS.output_name,
